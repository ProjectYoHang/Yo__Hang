	...
	<form action="./write_ok.do" method="post" name="wfrm">
		<div class="contents_sub">	
			...
			<div class="board_write">
				...
				<tr>
					<th class="top">글쓴이</th>
					<td class="top"><input type="text" name="qna_id" value="" class="board_view_input_mail" maxlength="10" /></td>
				</tr>
				<tr>
					<th>제목</th>
					<td><input type="text" name="qna_subject" value="" class="board_view_input" /></td>
				</tr>
				<tr>
					<th>비밀번호</th>
				...
				<tr>
					<th>내용</th>
					<td><textarea name="qna_content" class="board_editor_area"></textarea></td>
				</tr>
				</table>
